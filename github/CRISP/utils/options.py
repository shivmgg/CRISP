...
parser.add_argument("--dataset", type=str, default='SVHN_train')

parser.add_argument("--val_dataset", type=str, default='SVHN_test')
...
parser.add_argument("--disable_validation", type=int, default=False)
parser.add_argument("--val_aug", type=int, default=False)
parser.add_argument("--num_pref_classes", type=int, default=10)
